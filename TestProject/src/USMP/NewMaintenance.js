...
export default class NewMaintenance extends Component {
	constructor(props){
		...
		this.state={
			...
			haulDebris:'0',
			scalingRockSlopes:'0',
			roadTrailAlignment:'0',
			repairRockfallBarrier:'0',
			repairRockfallNetting:'0',
			sealingCracks:'0',
			guardrail:'0',
			cleaningDrains:'0',
			flaggingSigning:'0',
			...
			totalPercent:'0',
			designPseVal:'0',
			removeDitchDebrisVal:'0',
			removeRoadTrailDebrisVal:'0',
			relevelAggregateVal:'0',
			relevelPatchVal:'0',
			drainageImprovementVal:'0',
			deepPatchVal:'0',
			haulDebrisVal:'0',
			scalingRockSlopesVal:'0',
			roadTrailAlignmentVal:'0',
			repairRockfallBarrierVal:'0',
			repairRockfallNettingVal:'0',
			sealingCracksVal:'0',
			guardrailVal:'0',
			cleaningDrainsVal:'0',
			flaggingSigningVal:'0',
			other1Val:'0',
			other2Val:'0',
			other3Val:'0',
			other4Val:'0',
