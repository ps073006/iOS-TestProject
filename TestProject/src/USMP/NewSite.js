...
let realm = new Realm({schema: [SiteSchema,SiteSchema2]});*/
...
export default class NewSite extends Component {
	...
	constructor(props){
		...
		this.state={
			...
			fmlaId:'',
			fmlaDescription:'',
			prelimLandslideRoadWidthAffected:'0',
			prelimLandslideSlideErosionEffects:'0',
			prelimLandslideLengthAffected:'0',
			prelimRockfallDitchEff:'0',
			prelimRockfallRockfallHistory:'0',
			prelimRockfallBlockSizeEventVol:'0',
			impactOnUse:'0',
			aadtUsage:'0',
			aadtUsageCalcCheckbox:true,
			editable:false,
			prelimRatingLandslideTotal:'0',
			prelimRatingRockfallRotal:'0',
			prelimRating:'0',
			slopeDrainage:'0',
			hazardRatingAnnualRainfall:'0',
			hazardRatingSlopeHeightAxialLength:'0',
			hazardLandslideThawStability:'0',
			hazardLandslideMaintFrequency:'0',
			hazardLandslideMovementHistory:'0',
			hazardRockfallMaintFrequency:'0',
			caseOneStrucCond:'0',
			caseOneRockFriction:'0',
			caseTwoStrucCondition:'0',
			caseTwoDiffErosion:'0',
			hazardRatingLandslideTotal:'0',
			hazardRatingRockfallTotal:'0',
	...
	onDateChange(date) {
	  ...
	  offlineSave(){
		...
		let site = realm.create('SITE_INFORMATION',{
			...
			hazardType:hazardlinks_last_id,
			...
			comment:comment_last_id,
			fmla:fmla_last_id,
			preliminaryRatingLandslideId:prelimLandslides_last_id,
			preliminaryRatingRockfallId:prelimRockfalls_last_id,
			...
			hazardRatingLandslideId:hazardLandslides_last_id,
			hazardRatingRockfallId:hazardRockfalls_last_id,
		...
		Alert.alert("New id:"+ last_id +" has been saved in Offline database." );
	...
	return (
      ...
      <View style={styles.container}>
      	...
      	<View style={styles.header}>
  	  		<Icon name="menu" 
		style={{marginTop:20,marginRight:120}}  
